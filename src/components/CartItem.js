...
import { deleteItem, resetCart, decrementQuantity,incrementQuantity } from '../redux/KmSlice';
    ...
    <div>
        {
            ...
            className='flex items-center justify-between gap-10 nt-6 mt-5'
            >
        ...
        className='mt-5 bg-red-500 text-white nt-8 ml-7 py-1 px-6 hover:bg-red-800 duration-300'>
            Reset Cart
        </button>
